    ...
    <div className="drawer">
      ...
      <div className="drawer-side z-50">
        <label
          ...
          className="drawer-overlay bg-basic-green "
        ></label>
        <ul className="menu  m-0 w-80 min-h-full bg-basic-green text-base-content z-50">
          <li>
            <h1 className="text-4xl font-bold text-accent-blue">
          ...
          <li>
            <a
              href="#home"
              onClick={closeDrawer}
              className="text-3xl bg-accent-blue rounded-none m-1 mt-0 text-white hover:text-accent-blue"
            >
              Welcome
            </a>
          </li>
