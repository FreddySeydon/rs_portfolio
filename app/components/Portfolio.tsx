...
const Portfolio = () => {
  return (
    <div className="flex flex-col bg-basic-green h-fit">
      <h1 className="uppercase text-5xl text-slate-100 font-bold ml-10 mt-8">Portfolio</h1>
    <div
      className="flex flex-col lg:flex-row p-5 bg-basic-green pt-8 justify-evenly h-min"
        ...
        <div className="card lg:card-side w-full bg-base-100 shadow-xl">
          ...
          <div className="card-body w-full lg:w-1/2">
            ...
            <p className="text-2xl">
              ...
              corresponding position so that you don't always have to search for
              the right position during rehearsals. This can be very difficult
              with an instrumental playback without clickable Vocals.
            </p>
        ...
        <div className="card lg:card-side w-full bg-base-100 shadow-xl">
          ...
          <div className="card-body w-full lg:w-1/2 lg:order-1">
            ...
            <p className="text-2xl">
              ...
              new question is sent by push message, which users can then answer.
              Once they have answered the question, they can see their friends'
              answers. The app is my final project of the boot camp at the WBS
              Coding School made in React Native with Express backend and is
              currently being further developed by me. A beta version is
              available by invitation via the Google Play Store.
            </p>
            <a href="http://songs.renja.cc" target="_blank">
              <div className="card-actions justify-center mt-2 mb-2">
                <button className="btn btn-primary text-2xl lg:text-xl w-full">
