...
const About = () => {
  ...
  return (
    <div className="flex flex-col w-full lg:flex-row p-5">
      <div className="w-1/3 h-1/2 rounded-box bg-cyan-100 pl-5 pr-5 drop-shadow-sm">
      ...
      <div className="w-1/3 rounded-box bg-cyan-100 p-5 drop-shadow-sm">
        ...
        <h3 className="text-2xl font-bold text-center mb-5 text-accent-blue">
        ...
        <div className="grid grid-cols-4 gap-2">
          {skillIcons.map((IconComponent, index) =>
            index <= 11 ? (
              ...
              <Skill IconComponent={IconComponent} key={index} index={index} fill="rgb(156, 189, 178)" />
              </div>
            ) : null
          )}
        </div>
