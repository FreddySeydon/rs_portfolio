        ...
        <div className="flex flex-col items-center justify-evenly lg:flex-row w-full">
          <div className="w-50 lg:w-1/3 flex flex-col p-2 hover:scale-110 transition-all drop-shadow-md sm:pb-7">
            ...
            <div className="bg-basic-green p-4 mb-5 lg:mb-0">
              <h1 className="text-3xl lg:text-5xl text-center lg:pb-2 md:text-5xl">
                Renja Ferry Schmakeit
              </h1>
              <h3 className="text-xl lg:text-3xl text-center md:text-3xl">
                Junior Web- and App-Developer
              </h3>
            </div>
          </div>
          <div className="flex flex-col justify-center content-center w-full lg:w-1/3 pb-7 lg:pb-0">
            <h3 className="text-3xl text-center font-bold mb-5 text-accent-blue pr-10 pl-10 lg:pr-0 lg:pl-0">
            ...
            <div className="flex flex-col mt-2 lg:mt-10">
              <a
                href="#portfolio"
                className="btn btn-lg btn-accent bg-accent-blue mb-2 text-white"
              >
                <div className="text-2xl lg:text-xl">Go to my Portfolio</div>
              </a>
              <a
                href="#about"
                className="btn btn-lg btn-neutral bg-slate-100 mb-2"
              >
